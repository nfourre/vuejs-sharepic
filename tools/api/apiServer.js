...
function validatePicture(picture) {
  if (!picture.title) return "Title is required.";
  if (!picture.authorId) return "Author is required.";
  if (!picture.url) return "Picture Url is required.";
  return "";
}

function validateComment(comment) {
  if (!comment.text) return "Text is required.";
  if (!comment.authorId) return "Author is required.";
  if (!comment.imageId) return "Image is required.";
  return "";
}
